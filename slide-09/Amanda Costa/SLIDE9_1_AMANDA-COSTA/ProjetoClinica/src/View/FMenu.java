...
public class FMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/icones/cadastrar.png"))); // NOI18N
        jMenu1.setText("Arquivo");

        cad_paciente.setText("Cadastro de Paciente");
        cad_paciente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cad_pacienteActionPerformed(evt);
            }
        });
        jMenu1.add(cad_paciente);

        jMenuBar1.add(jMenu1);

        jMenu2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/icones/excluir.png"))); // NOI18N
        jMenu2.setText("Sair");
    ...
    private void cad_pacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad_pacienteActionPerformed
        ...
        FCadastroPaciente fcp = new FCadastroPaciente();
        fcp.setVisible(true);
